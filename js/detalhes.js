...
//busca os botoes da pagina
    ...
    const btnNaoGostei =
    document.getElementById("btnNaoGostei");

    const btnAssistirDepois =
    document.getElementById("btnAssistirDepois");
...
btnFavorito.addEventListener("click", () =>{
    ...
    const jaExiste =
    favoritos.find(f => f.id === filme.id); // find procura um elemento dentro de uma array
...
btnNaoGostei.addEventListener("click", () =>{
    ...
    const jaExiste =
    naogostei.find(f => f.id === filme.id); // find procura um elemento dentro de uma array
...
btnAssistirDepois.addEventListener("click", () =>{
    ...
    const jaExiste =
    assistirdepois.find(f => f.id === filme.id); // find procura um elemento dentro de uma array
